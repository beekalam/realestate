                    ...
                    <div class="row">
                        <div class="form-body col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" id="owner_name" name="owner_name" class="form-control input-sm"
                                           placeholder="نام"
                        ...
                        <div class="form-body col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="owner_tel" name="owner_tel" class="form-control input-sm"
                                ...
                                <?php if ($pt == 'apartment' || $pt == 'land'): ?>
                                    <div class="form-body col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="age" name="age" class="form-control input-sm"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="unit_per_story" name="unit_per_story"
                                                       class="form-control input-sm" placeholder="تعداد واحد در طبقه"
                                ...
                                <?php if ($pt == 'store'): ?>
                                    <div class="form-body col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="parvane_description" name="parvane_description"
                                                       class="form-control input-sm" placeholder="توضیحات پروانه"
                        ...
                        <?php if ($pt == 'apartment' || $pt == 'land' && $dt != 'none'): ?>
                            <div class="form-body col-xs-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="price_per_square_meter" name="price_per_square_meter"
