...
<html lang="en" dir="rtl">
    ...
    <body class=" login">
        ...
        <div class="logo page-background" style="margin-top:0; " >
                ...
                <!-- <img style="margin:0; " src="<?php echo base_url() ?>assets/logo.jpg"  -->
        ...
        <div class="content" style="border-radius: 10px !important;">
            ...
            <form class="login-form" action="<?php echo base_url('login') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="username" class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="نام کاربری" name="username"
                ...
                <div class="form-actions">
                    ...
                    style="box-shadow:inset 2px -3px rgba(0,0,0,0.15) !important;border-radius: 5px !important;">ورود</button>
                    </div>
